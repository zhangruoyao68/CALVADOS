...
# System parameters
box_a, box_b, box_c = 500.0, 500.0, 500.0  # box lengths in Å
n_chain = 200
n_monomer = 137  # beads per chain
cutoff = 5.0  # Å

# Load and verify system
traj = md.load('./hnRNPA1LCD_200/checkpoint.pdb') # checkpoint.pdb should be same as the backup pdb
...
nx.write_gml(G, "./A1LCD_200_calvados.gml")
print("Graph saved as 'A1LCD_200_calvados.gml'")
